...
<body>
<h5>The total amount due for this rent is <c:out value="${fullPrice}" />$ .Please proceed to your selected garage.</h5>
<h5>Vehicle Activation Code for this vehicle is <c:out value="${keyCode}" />.Please use this activation code to start using your vehicle after payment at the garage.</h5>
</body>
</html>